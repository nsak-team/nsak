...
Figure~\ref{fig:NSAK-use-case-diagram} illustrates the use case structure of the proposed \gls{nsak} modular framework.
...
Finally, the system performs a cleanup procedure in which all scenario-specific resources, processes, and drills are terminated.
...
\begin{longtable}{@{} >{\columncolor{blue!15}}l >{\raggedright\arraybackslash}p{0.75\textwidth} @{}}
    ...
    \textbf{UC-08} & \textbf{Use-Case:} Execute Drills \par
                     ...
                     \textbf{Result:} Configured attack drills executed. \par
    \midrule
    % --- UC-09 --------------------------------------------------
