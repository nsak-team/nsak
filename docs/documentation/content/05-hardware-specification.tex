\subsection{Hardware Specification}\label{subsec:hardware-specification}
...
\subsubsection{Category I — Inline:}\label{subsubsec:category-i-inline:}
...
\subsubsection{Category II — Wireless:}\label{subsubsec:category-ii-wireless:}
