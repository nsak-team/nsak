...
This underlines the need for cost-effective and easy-to-use security methods and tools to identify and defend against cyberattacks.

In practice, the method of combining red team activities and blue team observation techniques is widely adopted within the cybersecurity community~\cite{}.\todo{missing citation for this claim}
...
\todo{We have to glue together this two paragraphs, the above paragraph describes a common method and the next the tools}

One approach to reduce operational security costs is to adopt multiple modular frameworks that can be easily extended, configured, and executed continuously in a controlled manner~\cite{Garg2024AIEconomicsCyberattacks}.
The threat emulation frameworks introduced by Zilberman et al.\ evaluate multiple attack phases, including lateral movement, persistence, and attack execution.
