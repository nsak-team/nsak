...
\subsection{Information security methods and conceptional frameworks}{subsec:information-security-methods-and-conceptional-frameworks}
...
\subsection{Information security tools and software framworks}{subsec:information-security-tools-and-software-framworks}
...
\subsection{Lower the bar with modularity and automation}{subsec:lower-the-bar-with-modularity-and-automation}
...
In the summary of their paper, Zilberman et al.\ are highlighting the necessity of the following features~\cite{Zilberman2020SoKThreatEmulators}:
\begin{itemize}
