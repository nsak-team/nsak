...
Even though we agree with the importance of the highlighted design requirements, we are not able to implement them all in the context of this project.
The focus is on verifying the feasibility of building a framework which provides modularity and automation and shows which advantages it can provide over existing solutions.
Because we are planning to build upon this PoC, we will incorporate the design requirements in the chapter architecture and design~\ref{ch:architecture-and-design} of this paper and list them in the future work~\ref{sec:future-work} section.
