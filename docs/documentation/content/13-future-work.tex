...
\todo{This is only a list of ideas for now}

\begin{itemize}
    \item REST API: Feature parity with the CLI
    \item Web GUI: Possibly using the REST API, feature parity with the CLI
    \item Better configurability implementation of the framework, scenarios, drills and environments
    \item Better cleanup procedure implementation
    \item Test coverage
\end{itemize}


%\section{Network Environments}\label{sec:network-environments}
%
