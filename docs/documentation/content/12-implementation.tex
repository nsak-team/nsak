...
\subsubsection{Network Topoplgy}{subsubsec: Network Topology}
...
\textbf{The Hostapd Drill} is responsible for configuring the wireless network interface of the NSAK device in access mode
mode.
