...
\begin{figure}[H]
	...
	\caption{The Component diagram illustrated how the systems interact which each other}
	\label{fig:project2nsakcomponentdiagram}
\end{figure}

The component diagram (Figure~\textbf{\ref{fig:project2nsakcomponentdiagram}}) illustrates how the different subsystems and their respective components should interface each other.
