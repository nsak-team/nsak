...
\textbf{Description:}
Direct inline ~\ref{fig:lan-inline} bridge between a client or switch and router.
...
\textbf{Description:}
The NSAK device is inline and lets traffic pass but intercepts as \gls{rogueap} (RAP) and capture data ~\ref{fig:lan-wlan-sniffing}.
