...
%------------ START MAIN PART ------------
    ...
    \chapter{First Part Thesis: Evaluation}\label{ch:first-thesis-chapter}
    \input{content/02-introduction}
    \input{content/03-current-state-of-research}
    ...
    \input{content/04-hardware-evaluation}
    \input{content/05-hardware-specification}


    \section{Software Selection}\label{sec:framework-compnents}
    \input{content/06-framework-technology-stack}
    \input{content/07-system-dependencies}


    \chapter{Architecture and Design}\label{ch:architecture-and-design}
    \input{content/08-framework-concepts}
    \input{content/09-user-story}
    \input{content/10-component-diagram}
    \input{content/10.1-sequence-diagram}


    \chapter{Second Part Thesis: Implementation}\label{ch:second-thesis-chapter}
    \input{content/11-method}
    \input{content/12-implementation}
    \input{content/12.1-evaluation}
    \input{content/13-future-work}
