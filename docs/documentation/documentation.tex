...
%------------ START MAIN PART ------------
    ...
    \chapter{First Thesis Chapter}\label{ch:first-thesis-chapter}
    \input{content/introduction}
    \input{content/specification}
    \input{content/evaluation}
    \input{content/architecture-and-design}

    \chapter{Second Thesis Chapter}\label{ch:second-thesis-chapter}
