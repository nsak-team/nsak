...
%    \institute{TBD}
    \version{1.0}
    \titlegraphic*{\includegraphics{../assets/pictures/title}}
...
%------------ START MAIN PART ------------
    ...
    \input{content/04-framework-concepts}
    \input{content/05-network-environments}
    \input{content/06-user-story}
    \input{content/07-component-diagram}
    \input{content/07.1-sequence-diagram}
    ...
    \input{content/10-implementation}


    \chapter{Evaluation and Discussion}\label{ch:evaluation_and_discussion}
    \input{content/11.1-evaluation}
    \input{content/11.2-discussion}


    \chapter{Future Work and Conclusion}\label{ch:future_work_and_conclusion}
    \input{content/12-future-work}
    \input{content/13-conclusion}
