...
%------------ START MAIN PART ------------
    ...
    \chapter{Concept and Hardware Evaluation}\label{ch: System Evaluation}
    \input{content/04-hardware-evaluation}
    \input{content/05-network-environments}
    ...
    \chapter{Evaluation and Discussion}\label{ch: Evaluation and Discussion}
    \input{content/12.1-evaluation}
    \input{content/12.2-discussion}
