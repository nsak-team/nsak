...
\input{content/02-design-and-architecture}

\section{Hardware Evaluation}\label{sec:hardware-evaluation}
\input{content/03-hardware-evaluation}

\section{Implementation}\label{sec:implementation}
\input{content/04-nsak-framework}
\input{content/05-mitm}
\input{content/06-rogue-ap}
