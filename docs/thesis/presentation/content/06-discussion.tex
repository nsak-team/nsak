        ...
        \begin{columns}[T,onlytextwidth]
            ...
            \begin{column}{0.5\textwidth}
                ...
                \begin{itemize}
                    ...
                    \item \scriptsize \textbf{Model tier matters}: \texttt{qwen3:30b} unusable
                    \item \scriptsize Manual qualitative scoring
                \end{itemize}
            \end{column}
        \end{columns}
    \end{onlyenv}
...
\begin{frame}
    \framesubtitle{RAG-Pipeline Agent}
    \begin{figure}
        Keine Ahnung warum es das diagram nicht rendert ?????
        \centering
        \includegraphics[width=0.5]{assets/rag-future}
        \label{fig:rag-future.drawio}
    \end{figure}
\end{frame}
...
\begin{frame}{Conclusion}
    ...
    \begin{itemize}
        ...
        \item[\faCheck] Scripted scenarios excel in \textbf{speed and reproducibility}; the agent adds \textbf{reasoning and assessment}, limited by model capability.
        \item[\faCheck] \textbf{Multi-agent decomposition} improves smaller models by reducing context complexity and increasing consistency.
