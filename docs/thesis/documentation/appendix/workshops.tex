...
\newpage
\chapter{Workshops}\label{ch:workshops}
...
\section{Brainstorm Scenario Selection}\label{sec:brainstorm-scenario-selection}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/scenario_brainstorming/scenario_brainstorming}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/scenario_brainstorming/scenario_selection}
...
\section{NSAK Scenario: Network Discovery - Red Team}\label{sec:nsak-scenario-network-discovery-red-team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/user_story_maps/user_story_map_network_discovery}
	\caption{NSAK Scenario: Network Discovery - Red Team}
	\label{fig:usm-network-discovery}
\end{figure}


\section{NSAK Scenario: TLS Downgrade Poodle - Red Team}\label{sec:nsak-scenario-tls-downgrade-poodle-red-team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/user_story_maps/user_story_map_tls_downgrade_poodle}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/user_story_maps/environment_tls_downgrade_poodle}
...
\section{NSAK Scenario: Honeypot - Blue Team}\label{sec:nsak-scenario-honeypot-blue-team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/user_story_maps/user_story_map_honeypot}
	\caption{NSAK Scenario: Honeypot - Blue Team}
	\label{fig:usm-honeypot}
\end{figure}

\section{NSAK Scenario: Traffic Capture - Red Team}\label{sec:nsak-scenario-traffic-capture-red-team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/user_story_maps/user_story_map_traffic_capturing_and_exfiltration}
	\caption{NSAK Scenario: Traffic Capture - Red Team}
	\label{fig:usm-traffic-capture}
\end{figure}

\section{NSAK Scenario: Intrusion Detection - Blue Team}\label{sec:nsak-scenario-intrusion-detection-blue-team}
...
This scenario covers the following bullet point from the thesis proposal: \enquote{Bereitstellung von Funktionen zur Erkennung, Protokollierung und Analyze verdächtiger Aktivitäten als Teil defensiver Massnahmen}

\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/user_story_maps/user_story_map_intrution_detection}
	\caption{NSAK Scenario: Intrusion Detection - Blue Team}
	\label{fig:usm-intrusion-detection}
\end{figure}

\section{NSAK Scenario: \gls{AI} - Purple Team}\label{sec:nsak-scenario-ai-purple-team}

\href[]{https://gitlab.ti.bfh.ch/groups/gausf1-vonal3/-/milestones/13#tab-issues}{\gls{AI} Purple Team Milestone}

Even tough we were not quite hooked by the current hype around \gls{AI} during the predecessor project~\ref{sec:predecessor-project-project-2},
we now see a huge potential in integrating it into the \gls{NSAK}-framework, especially in because of the tool-calling capabilities of agentic \gls{AI}.
In our point of view, the possibility that common blue and red team activities, which require a lot of know how and time, can be simplified or speed up is really promising.
This scenarios would explore if it's possible that intrusion detection or network reconnaissance tasks can be assisted or maybe even fully automated by an \gls{AI}-agent.

\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/pictures/user_story_maps/user_story_map_ai_purpleteam}
	\caption{NSAK Scenario: AI - Purple Team}
	\label{fig:usm-ai-purple-team}
\end{figure}
