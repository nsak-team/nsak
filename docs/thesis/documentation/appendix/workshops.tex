...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{appendix/appendix-media/Workshops/brainstorm-scenarios}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{appendix/appendix-media/Workshops/listing-scenarios-red-blue}
...
\subsection{NSAK Scenario: Network Discovery - Red Team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{appendix/appendix-media/Workshops/USM-network-discovery}
	\caption{NSAK Scenario: Network Discovery - Red Team}
	\label{fig:usm-network-discovery}
\end{figure}


\subsection{NSAK Scenario: TLS Downgrade Poodle - Red Team}

\href{https://gitlab.ti.bfh.ch/groups/gausf1-vonal3/-/milestones/8#tab-issues}{TLS Downgrade Poodle Milstone}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{appendix/appendix-media/Workshops/USM-tls-downgrade}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{appendix/appendix-media/Workshops/Environment-tls-poodle}
...
\subsection{NSAK Scenario: Honeypot - Blue Team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{appendix/appendix-media/Workshops/USM-honeypot}
	\caption{}
	\label{fig:usm-honeypot}
\end{figure}

\subsection{NSAK Scenario: Traffic Capture - Red Team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{appendix/appendix-media/Workshops/USM-traffic-capture}
	\caption{}
	\label{fig:usm-traffic-capture}
\end{figure}

\subsection{NSAK Scenario: Intrusion Detection - Blue Team}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{appendix/appendix-media/Workshops/USM-intrusion-detection}
	\caption{}
