...
During the risk assessment~\ref{sec:risk_assessment} we identified that the \glsxtrshort{AI} tokens required to use cloud based \glsxtrshort{LLM}s might be very expensive, and it's really hard to estimate the costs.
