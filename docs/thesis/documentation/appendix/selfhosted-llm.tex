...
\todo{Refactor the section: Move all information in their respective subsections, etc.}
...
The system setup described in~\ref{lst:llm-system-setup} will configure and expose the Ollama \gls{API} and OpenWeb UI via NGINX,
...
The \gls{Nginx} default.conf~\ref{lst:nginx-default-conf} configures the web server to terminate the SSL connection and
...
\include{appendix/selfhosted-services/base-setup}
\include{appendix/selfhosted-services/nginx-reverse-proxy}
\include{appendix/selfhosted-services/ollama-llm-server}
\include{appendix/selfhosted-services/openwebui-llm-web-chat}
\include{appendix/selfhosted-services/drawio-mcp-diagram-tool}
\include{appendix/selfhosted-services/netbox-network-inventory-system}
\include{appendix/selfhosted-services/grafana-loki-logging-system}
