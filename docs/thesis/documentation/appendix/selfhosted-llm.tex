...
act as reverse proxy for the \enquote{Open WebUI} and the Ollama API under the directory \mintinline{bash}{/llm/}.
...
Later on we can use the Ollama API served under \mintinline{bash}{/llm/} as a backend for \glsxtrshort{AI} agents.
