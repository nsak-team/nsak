...
\newpage
\begin{lstlisting}[language=bash,caption={UFW configuration},label={lst:llm-system-setup}]
...
\begin{lstlisting}[language=bash,caption={Example Python Script},label={lst:restart-swag-container}]
