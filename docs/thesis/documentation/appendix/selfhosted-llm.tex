...
# Check nvidia driver is loaded and the GPU was correctly detected
nvidia-smi

# Install Ollama and enable systemd service
sudo pacman -Syu ollama ollama-cuda
...
# Start the services again, this time they should run successfully. Cevat:
