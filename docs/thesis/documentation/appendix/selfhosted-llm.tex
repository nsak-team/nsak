...
act as reverse proxy for the \enquote{Open WebUI} and the Ollama API under the directory \mintinline{text}{/llm/}.
...
Later on we can use the Ollama \gls{API} served under \mintinline{text}{/llm/} as a backend for \glsxtrshort{AI} agents.
