...
It must be noted, that because we usually review and close the tickets at the end of the sprint, the charts are not representative in most cases.

\paragraph{Milestone Review: Compare Frameworks}\label{par:milestone-review-compare-framework}

The Compare Frameworks~\ref{subsubsec:milestone-research-compare-frameworks} milestone is completed as illustrated in~\ref{fig:milestone-description-framework-comparison]}.
...
\begin{figure}[H]
    ...
    \label{fig:milestone-description-framework-comparison]}
\end{figure}

\paragraph{Milestone Review: Research AI-Integration}\label{par:milestone-review-research-ai-integration}

As shown in~\ref{fig:milestone-research-ai-integration]}, the milestone Research \gls{AI}-Integration~\ref{subsubsec:milestone-research-ai-integration} is completed.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{../assets/screenshots/project_management/sprint_2/milestone_research_ai_integration_charts}
    \caption{Milestone Description and Charts: Research AI-Integration}
    \label{fig:milestone-research-ai-integration]}
\end{figure}

\paragraph{Milestone Review: Configuration Management}\label{par:milestone-review-configuration-management}

The burnup and burndown charts below~\ref{fig:milestone-description-configuration-management]} are showing that the milestone Configuration Management~\ref{subsubsec:milestone-configuration-management} is implemented as planned.
...
\begin{figure}[H]
    ...
    \label{fig:milestone-description-configuration-management]}
\end{figure}
...
\begin{itemize}
    ...
    \item Reviewing on a more regular basis would also lead to more accurate burnup and burndown charts.
    \item We decided to not include the charts in the future, because it makes no sense to adjust our process only for the sake of good-looking charts.
\end{itemize}
