...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../assets/screenshots/project_management/sprint_1/milestone_project_planing_charts}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../assets/screenshots/project_management/sprint_1/sprint_retro_1}
