# Benchmark Result 15 from Run 8e5fbd3a-4c89-4fc9-983f-a2fbaef5fd96

| Key            | Value                                |
|:---------------|:-------------------------------------|
| Benchmark UUID | 8e5fbd3a-4c89-4fc9-983f-a2fbaef5fd96 |
| Run index      | 15                                   |
| Run UUID       | da6d527d-cd0e-4a02-86f9-61ddbb4b7b19 |
| Scenario       | AI Reconnaissance                    |
| Setup          | eval_containerlab_bfh                |
| Timestamp      | 2026-05-24T19:38:05.803996+02:00     |
| Success        | No                                   |
| Duration (s)   | 507                                  |
...
Traceback (most recent call last):
  ...
  File "/usr/lib/python3.13/smtplib.py", line 555, in mail
    return self.getreply()
           ~~~~~~~~~~~~~^^

  File "/usr/lib/python3.13/smtplib.py", line 410, in getreply
    raise SMTPServerDisconnected("Connection unexpectedly closed: "
                                 + str(e))

SMTPServerDisconnected: Connection unexpectedly closed: [SSL: RECORD_LAYER_FAILURE] record layer failure (_ssl.c:2659)
