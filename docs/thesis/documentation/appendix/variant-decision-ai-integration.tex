...
\todo{enhance the decision with technical background}
...
\todo{This is not correct anymore: we use LangChain Tools instead of MCP for tool calling, which is their own abstraction over vendor specific APIs}
