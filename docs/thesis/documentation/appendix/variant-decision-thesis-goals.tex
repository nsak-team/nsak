...
\newpage
\section{Variant Decision: Thesis Goals}\label{sec:variant-decision-thesis-goals}
...
For example, the Web \gls{GUI} was already deprioritized during the discussion of the variants, which is reflected in the project goals~\ref{sec:project-goals} but not here.

\subsection{Variant 1: AI vs Manually Built Scenarios}\label{subsec:variant-1-ai-vs-manually-built-scenarios}
...
In this option most of the evaluated scenarios will not be realized in favor of \glsxtrshort{AI} based scenarios, which also requires additional research~\ref{subsubsec:ai-integration-research}.
The basic idea is to implement scenarios for network discovery~\ref{subsubsec:network-discovery-red-team}, intrusion detection~\ref{subsubsec:intrusion-detection-blue-team} and an \glsxtrshort{AI} based scenario with the same capabilities~\ref{subsubsec:ai-scenarios}.
In the evaluation of the thesis we can then assess the quality of the \glsxtrshort{AI} based scenarios itself~\ref{subsubsec:ai-scenario-evaluation} and in comparison to the manually built scenarios~\ref{subsec:ai-vs-engineered-scenarios}.
...
\subsection{Decision}\label{subsec:variant-decision-thesis-goals}

The stakeholders and project team decided in favor of \textbf{Variant 1: AI vs Manually Built Scenarios}~\ref{subsec:variant-1-ai-vs-manually-built-scenarios} in the checkpoint meeting~\ref{tab:meeting-notes-checkpoint2}.
