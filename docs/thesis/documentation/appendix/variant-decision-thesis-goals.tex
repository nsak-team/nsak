...
For example, the Web \gls{GUI} was already deprioritized during the discussion of the variants, which is reflected in the project goals~\ref{ch:project-goals} but not here.
...
In this option most of the evaluated scenarios will not be realized in favor of \glsxtrshort{AI} based scenarios, which also requires additional research~\ref{subsec:ai-integration-research}.
The basic idea is to implement scenarios for network discovery~\ref{subsec:network-discovery-red-team}, intrusion detection~\ref{subsec:intrusion-detection-blue-team} and an \glsxtrshort{AI} based scenario with the same capabilities~\ref{subsec:ai-scenarios}.
In the evaluation of the thesis we can then assess the quality of the \glsxtrshort{AI} based scenarios itself~\ref{subsec:ai-scenario-evaluation} and in comparison to the manually built scenarios~\ref{subsec:ai-vs-engineered-scenarios}.
