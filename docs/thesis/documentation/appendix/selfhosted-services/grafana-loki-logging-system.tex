...
\newpage
\begin{listing}[H]
    \inputminted[lastline=85]{yaml}{listings/self_hosted_loki/compose.yaml}
    \caption{Grafana / Loki Compose File: 1}
    \label{lst:grafana-loki-compose-yml-1}
\end{listing}

\newpage
\begin{listing}[H]
    \inputminted[firstline=86]{yaml}{listings/self_hosted_loki/compose.yaml}
    \caption{Grafana / Loki Compose File: 2}
