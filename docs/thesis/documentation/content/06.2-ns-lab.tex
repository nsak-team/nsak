...
The qualitative findings are not evaluated in detail here, because the BFH nslab is still in use.
...
\midrule
claude-opus-4-7 (multi-agent)       & 7 & 9 & All major structural risks found; SNMP, open DNS recursion and cloned keys missed \\
...
\texttt{nmap} \gls{NSE} output, with no fabricated CVE identifiers or version numbers.
...
alongside \gls{TCP} and discovered all of the flaws listed above.
