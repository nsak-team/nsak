...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{l c c c c c c}
            ...
            Static Scenario                & 1780 s         & ---          & --          & --             & --             & 1/1\textsuperscritp{**}                      \\
            \hline
        \end{tabular}
    }
...
103 of the 109 attempts aborted instantly because the Anthropic \gls{API} usage limit was reached, as the model's guardrail monthly quota got triggered mid-benchmark.
