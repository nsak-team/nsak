...
with respect to the research questions defined in Chapter~\ref{ch:introduction}, which are
...
In the more realistic BFH nslab segment, a network roughly seven times larger than
...
The nslab environment therefore confirms the \gls{Containerlab} findings.
