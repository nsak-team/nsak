...
During the DMZ-server container build process, a shell script located at \mintinline{python}|lib/environments/virtual_enterprise_network_lab/scripts/dmz_setup.sh | generates a named.conf file, specifying both options and master zones for reverse lookup. 
