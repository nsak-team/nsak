...
During the DMZ-server container build process, a set up shell script at \mintinline{python}|lib/environments/virtual_enterprise_network_lab/scripts/dmz_setup.sh | gets executed. 
...
In the second part, a puristic nginx web server with http and https gets created. 
HTTP traffic on port 80 gets redirected to https on port 443. To leave an artifact behind, a secret.txt is left with.   