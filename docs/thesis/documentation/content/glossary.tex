...
\newglossaryentry{Infomaniak}{
  name={Infomaniak},
  description={\textbf{Infomaniak} Swiss based IT service provider, specialized on domains, web hosting and cloud services.}
}
\newglossaryentry{FRITZ!Box}{
  name={FRITZ!Box},
  description={\textbf{FRITZ!Box} A widespread gateway for home networks sold by AVM GmbH, acting as a NAT gateway, router and DHCP server.}
}
