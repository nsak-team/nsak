...
\newglossaryentry{FRITZ!Box}{
  name={FRITZ!Box},
  description={\textbf{FRITZ!Box} A widespread gateway for home networks sold by AVM GmbH, acting as a \glsxtrshort{NAT} gateway, router and \glsxshort{DHCP} server.}
}
\newacronym[
