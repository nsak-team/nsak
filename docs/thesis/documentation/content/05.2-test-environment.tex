...
the intrusion detection scenarios~\ref{subsubsec:milestone-ai-purple-team},
...
The following listing~\ref{lst:containerlab-topology-yaml-exampel} shows an excerpt of a \gls{Containerlab} topology.yaml file as a segmented enterprise network consisting of WAN, DMZ, and LAN zones.
The configuration includes a firewall node that implements traffic filtering policies, as well as multiple hosts representing typical enterprise assets.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{../assets/diagrams/virtual-environments/virtual-environments.drawio}
