...
In the forward zone, domain names map to IP addresses, and in the reverse zone, files are resolved to IP addresses.The files are located under \mintinline{text}|libs/environments/virtual_enterprise_network_lab/scripts/dmz-web-server| \cite{nsakRepository2026}.
