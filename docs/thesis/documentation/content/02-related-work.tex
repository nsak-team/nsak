...
\subsection{AI and Language Model}


The development of \gls{LM} can be divided into several stages. \gls{LM} describes the technique for advancing language intelligence in machines. The first stage \gls{SLM} emerged around the 1990s, and the basic idea is to assume, that one can predict the next word. This model's lack of accuracy is due to the fact that an exponential number of transition probabilities are needed.
