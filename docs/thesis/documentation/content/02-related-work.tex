...
Building on this development, \gls{LLM} further increase the scale of PLMs by expanding parameter count and computational power.

These advances have led to Agentic AIs, in which LLMs empower autonomous agents capable of decision-making and executing complex tasks. 
