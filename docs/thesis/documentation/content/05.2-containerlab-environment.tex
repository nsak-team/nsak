...
as introduced in the concepts chapter~\ref{subsec:reproducible-test-environment-concepts}
...
For reconnaissance purposes, several vulnerabilities and flaws were introduced, which are partly mentioned in the previous sections and are presented in detail in Listing~\ref{lst:flaws-and-vulnerabilities}.
...
Listings~\ref{lst:containerlab-topology-yaml-example} in the appendix shows an excerpt of a \gls{Containerlab} \mintinline{bash}{virtual_enterprise_network_lab.clab.yaml} file.
