...
The \textit{Port Scan} drill receives the \mintinline{bash}{NetworkDiscoveryResultMap} produced by host discovery and runs \mintinline{bash}{nmap -sV --open} against each discovered \gls{IP}.
...
The primary output of the scenario is the \mintinline{bash}{NetworkDiscoveryResultMap}, which aggregates all results per interface.
