...
Well-known services such as HTTP, DNS, FTP, SMTP, SMB, and LDAP are mapped to a specific set of scripts (e.g.\ \mintinline{bash}{http-title}, \mintinline{bash}{dns-zone-transfer}, \mintinline{bash}{smb-security-mode}).
...
The primary output of the scenario is the \mintinline{bash}{ReconnaissanceScenarioResult}, which aggregates all results per interface.
