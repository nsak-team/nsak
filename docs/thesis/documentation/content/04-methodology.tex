...
a frontier model (\mintinline{bash}{Claude Opus 4.7}), an institutionally hosted open-weight model (\mintinline{bash}{gpt-oss:120b}), and a locally-run open-source model (\mintinline{bash}{qwen3:30b} via Ollama).
