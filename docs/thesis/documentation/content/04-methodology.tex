...
The benchmarks and plots are only presented over the sucessful run selection and the limitation or reliability is mentioned seperatly of the plots.
A successful run is defined a run: - that does not raise an exception apart from an the api is temporarily disconnected which pauses the loop.
