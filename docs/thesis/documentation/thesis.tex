...
%    \institute{TBD}
\version{1.0}
\titlegraphic*{\includegraphics{../assets/pictures/mascot_physical_lab}}
...
\input{content/05.2-containerlab-environment}
\input{content/05.3-ai-scenarios}
\input{content/05.4-reconnaissance-scenario}
\input{content/05.5-benchmark-suite}
\input{content/05.6-inference-services}
\input{content/06-evaluation}
\input{content/06.1-container-lab}
\input{content/06.2-ns-lab}
...
\input{appendix/test-environment-listings}
\input{appendix/reconnaissance-listings}
\input{appendix/configuration-management-listings}
\input{appendix/ai-scenarios-listings}
\input{appendix/media_deliverables}
%\input{appendix/runs-temp}
